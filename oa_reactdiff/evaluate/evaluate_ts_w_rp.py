...
from oa_reactdiff.evaluate.utils import set_new_schedule, inplaint_batch
EV2KCALMOL = 23.06
AU2KCALMOL = 627.5
...
parser.add_argument('--timesteps', dest='timesteps', default=250, type=int,
    help='timesteps')
parser.add_argument('--resamplings', dest='resamplings', default=5, type=
    int, help='resamplings')
parser.add_argument('--jump_length', dest='jump_length', default=5, type=
    int, help='jump_length')
parser.add_argument('--repeats', dest='repeats', default=5, type=int, help=
    'repeats')
...
parser.add_argument('--single_frag_only', dest='single_frag_only', default=
    1, type=int, help='single_frag_only')
parser.add_argument('--model', dest='model', default='leftnet', type=str,
    help='model')
parser.add_argument('--power', dest='power', default='2', type=str, help=
    'power')
args = parser.parse_args()
print('args: ', args)
config = dict(model=args.model, partition=args.partition, timesteps=args.
    timesteps, bz=args.bz, resamplings=args.resamplings, jump_length=args.
    jump_length, repeats=args.repeats, max_batch=-1, shuffle=False,
    single_frag_only=args.single_frag_only, noise_schedule='polynomial_' +
    args.power)
filename = ''
...
checkpoints = {'chiral':
    f'{tspath}/5edcbc9baced/ddpm-epoch=4159-val-totloss=585.78.ckpt',
    'leftnet_legacy':
    f'{tspath}/leftnet-78c7590798bc/ddpm-epoch=1059-val-totloss=648.90.ckpt',
    'leftnet4':
    f'{tspath}/leftnet-4-48f308df7ec4/ddpm-epoch=809-val-totloss=587.27.ckpt',
    'leftnet_all':
    f'{tspath}-All/leftnet-4-77ae3fd23222/ddpm-epoch=1619-val-totloss=605.85.ckpt'
    , 'leftnet_final':
    f'{tspath}-All/leftnet-8-70b75beeaac1/ddpm-epoch=1274-val-totloss=519.81.ckpt'
    , 'leftnet_1654':
    f'{tspath}-All/leftnet-8-70b75beeaac1/ddpm-epoch=1654-val-totloss=540.84.ckpt'
    , 'leftnet_1884':
    f'{tspath}-All/leftnet-8-70b75beeaac1/ddpm-epoch=1884-val-totloss=549.61.ckpt'
    , 'leftnet_2074':
    f'{tspath}-All/leftnet-8-70b75beeaac1/ddpm-epoch=2074-val-totloss=531.18.ckpt'
    , 'leftnet_2304':
    f'{tspath}-All/leftnet-8-70b75beeaac1/ddpm-epoch=2304-val-totloss=524.65.ckpt'
    }
...
dataset = ProcessedTS1x(npz_path=
    f'../data/transition1x/{args.partition}.pkl', center=True,
