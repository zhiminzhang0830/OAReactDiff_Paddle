...
class TestTS1x(unittest.TestCase):
    ...
    def setUpClass(cls) ->None:
        ...
        cls.dataset = ProcessedTS1x(npz_path=
            f'{TEST_ROOT}/../data/transition1x/train.pkl', center=True,
            pad_fragments=0, device='cpu', zero_charge=False, remove_h=
            False, single_frag_only=False, swapping_react_prod=False,
            use_by_ind=True)
